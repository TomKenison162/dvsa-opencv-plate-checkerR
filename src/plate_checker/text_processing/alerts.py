...
from text_processing.location_services import find_location
from db.database_con_or_clos import alert_log
from db.database_con_or_clos import update_location
